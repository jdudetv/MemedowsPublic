...
export async function randomWheelItems(data: any) {
  let WheelOptions = [
    ...
    { name: "1000 xp", chance: 500 },
    { name: "Timeout someone else", chance: 1000 },
    { name: "FIRESALE", chance: 500 },
    { name: "Yeet", chance: 50000 },
    { name: "OG CumZone", chance: 10000 },
    { name: "NUKE", chance: 1 },
  ];
  ...
  async function prizeLogic(
    ...
    switch (name.toLocaleLowerCase()) {
      case "hornyjail":
        ...
        await wait(300);
        GenericSound("HornyJail", asset`sounds/horny.wav`, 0, false);
        ...
        if (redempData.userId !== undefined) {
          updateDoc(doc(db, "users", redempData.userId), {
